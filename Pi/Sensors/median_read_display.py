...
if __name__ == "__main__":
    value = sensor.Measurement(trig3, echo3)
    samples = 5 # number of samples taken at once
    speed = 0.1 # time between individual readings
    while True:
        distance3 = value.raw_distance(sample_size=5, sample_wait=0.1)
        metric_distance = value.distance_metric(distance3) # get distance in cm
